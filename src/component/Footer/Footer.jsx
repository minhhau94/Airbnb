...
export default function Footer() {
  return (
    <footer className="mt-10 bg-gray-100 dark:bg-gray-900">
      <div className="px-20 sm:ml-28 grid grid-cols-2 gap-8 text-sm  py-5 md:grid-cols-4">
        <div>
      ...
      <hr />
      <div className="px-32 py-3 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
          © 2023 <a href="https://www.airbnb.com.vn/">Airbnb, Inc. </a>. Quyền
          Riêng Tư . Điều khoản .Sơ đồ trang web
        </span>
